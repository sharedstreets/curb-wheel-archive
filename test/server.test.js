...
test("server", async (t) => {
  ...
  let saved = await request.post({
    url: "http://0.0.0.0:8081/surveys/" + ref,
  ...
  let surveysResponse = await request.get("http://0.0.0.0:8081/surveys/" + ref);
