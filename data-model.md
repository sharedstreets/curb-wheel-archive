...
- A linear reference ID
- *For span-along features*: A wheel start location and a wheel end location (in metres) where the feature was created and then closed
- *For point-along features*: A wheel location (in metres) where the feature was created
...
- An adjusted location (in metres) where the image was captured (see Feature, above, for more information) (not created on the client side; added by the server later)
